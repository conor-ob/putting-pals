/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 35f7e2dad2043821220027f5cf0ae71b)
// Runtime types generated with workerd@1.20251217.0 2025-12-13 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		MY_VAR: "Top-level var" | "Staging var" | "Production var";
		TRPC_API_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VAR" | "TRPC_API_URL">> {}
}
