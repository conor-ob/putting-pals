import { aidanWalsh, aimeeOhanlon, brianObrolchain, cameronFolens, conorObrien, davidHynes, johnHannaway, phelimOconnor, richByrne, robJoy, robKeartland, stephenDevine } from "../competitors/puttingPalsCompetitors";
import { aldrichPotgieter, alexNoren, brysonDeChambeau, cameronYoung, carlosOrtiz, chrisGotterup, collinMorikawa, danielBerger, jacobBridgeman, jasonDay, jonRahm, ludvigAberg, mattFitzpatrick, maxHoma, michaelKim, patrickReed, rasmusHojgaard, roryMcilroy, ryanFox, scottieScheffler, shaneLowry, siWooKim, tomMcKibbin, tommyFleetwood, viktorHovland, wyndhamClark } from "../players/pgaTourPlayers";
