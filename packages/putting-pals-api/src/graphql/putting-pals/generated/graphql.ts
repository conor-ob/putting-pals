...
export type Query = {
  ...
  readonly leaderboardAggregate: LeaderboardV3;
  ...
  readonly leaderboardHoleByHoleAggregate: LeaderboardHoleByHole;
  ...
  readonly tournamentAggregate: Tournament;
...
export type LeaderboardHoleByHoleAggregateQuery = {
  readonly __typename: 'Query',
  readonly leaderboardHoleByHoleAggregate: {
    readonly __typename: 'LeaderboardHoleByHole',
    readonly tournamentId: string,
    readonly currentRound: number,
    readonly tournamentName: string,
