...
export type EventHub = {
  ...
  notSharingLocationFallbackDescriptionText?: Maybe<
...
export type LeaderboardStatSupportValues =
  | LeaderboardOddsSwing
  | LeaderboardSupportingString;
...
export type ListNodeItems =
  | NewsArticleContentSegment
  | NewsArticleParagraph
  | NewsArticlePlayerTournamentOdds
  | UnorderedListNode;
...
export type RyderCupContentFragments =
  | BroadcastTableFragment
  | ContentFragmentTabs
  | ContentStory
...
export type VideoPillConfig =
  | FranchisePillConfig
  | TopicStoriesPillConfig
  | TournamentsPillConfig
  | VideoFilterPillConfig;
