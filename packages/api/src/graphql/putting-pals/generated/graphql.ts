...
export type DomainScheduleMonthFieldsFragment = {
  readonly __typename: 'ScheduleMonth',
...
export type DomainScheduleFieldsFragment = {
  readonly __typename: 'Schedule',
...
export type DomainScheduleYearsQueryVariables = Exact<{
  tourCode: DomainTourCode;
}>;


export type DomainScheduleYearsQuery = {
  readonly __typename: 'Query',
...
export type DomainScheduleQueryVariables = Exact<{
  tourCode: Scalars['String']['input'];
  year?: InputMaybe<Scalars['String']['input']>;
}>;


export type DomainScheduleQuery = {
  readonly __typename: 'Query',
  readonly schedule: {
    readonly __typename: 'Schedule',
    readonly tour: string,
...
export type DomainCompleteScheduleQueryVariables = Exact<{
  tourCode: DomainTourCode;
}>;


export type DomainCompleteScheduleQuery = {
  readonly __typename: 'Query',
...
export type DomainUpcomingScheduleQueryVariables = Exact<{
  tourCode: Scalars['String']['input'];
}>;


export type DomainUpcomingScheduleQuery = {
  readonly __typename: 'Query',
...
export type DomainTournamentsQueryVariables = Exact<{
  ids?: InputMaybe<ReadonlyArray<Scalars['ID']['input']> | Scalars['ID']['input']>;
}>;


export type DomainTournamentsQuery = {
  readonly __typename: 'Query',
  readonly tournaments: ReadonlyArray<{
    readonly __typename: 'Tournament',
    readonly id: string,
    ...
    readonly tournamentStatus: DomainTournamentStatus,
    readonly features?: ReadonlyArray<DomainTournamentFeature> | null,
    readonly formatType: DomainFormatType,
    readonly roundStatusDisplay: string,
    readonly roundDisplay: string,
    readonly roundStatus: DomainRoundStatus,
